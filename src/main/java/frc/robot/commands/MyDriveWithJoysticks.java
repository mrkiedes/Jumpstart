 ...
 *
 */
public class MyDriveWithJoysticks extends CommandBase {
    ...
    public MyDriveWithJoysticks(MyDriveTrain subsystem, double left, double twist) {
    ...
    @Override
    public void execute() {
        m_myDriveTrain.myDriveArcade(left, twist);
    }
